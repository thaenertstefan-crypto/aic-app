...
3. improved: Schreibe eine verbesserte Version des Neins, die alle vier Schichten einhält — nah an der Stimme und den Worten der Person, nicht förmlicher als ihr Entwurf, passend zur Situation (gesprochene Antwort oder Nachricht). Wenn der Entwurf schon alle Schichten erfüllt, gib ihn leicht poliert oder unverändert zurück.
